...
{
public:
	static bool start_self();
	static bool kill_process(const std::wstring & exeName);
	static bool is_running(const std::wstring & exeName);
	...
	ProcessMonitor(const std::string& path, const std::string& args = "");
